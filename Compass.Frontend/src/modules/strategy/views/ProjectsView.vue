...
onMounted(() => {
  //  ARQ: A View agora é 100% agnóstica. 
  // Não fazemos mais fetch aqui. O App.vue garante que a Store já está hidratada!
});

// A View foca apenas em projetar os dados já calculados na Store
