...
import { useDecisionStore, type ScoredActionDto } from '@/modules/execution/stores/decisionStore';
import { useCommitmentsStore } from '@/modules/tactical/stores/commitmentsStore'; //  Injetado
